...
//Comienza el menu de opciones donde el usuario escogerá las prendas que desea comprar, para posteriormente conocer el cobro total de su compra
	while (running) {
		...
		//Funcion 1: Accesa a la clase Pantalones, en la cual el usuario decidirá qué atributos tendrá su pantalon como talla, tipo, epoca y seccion
		...
		//Funcion 2: Accesa a la clase Falda en donde el usuario podra escoger el tipo de falda que desea comprar, añadiendo las caracteristicas de
		...
		//Funcion 3: Accesa a la clase Blusa en donde el usuario podra escoger el tipo de blusa que desea comprar, añadiendo las caracteristicas de
		//talla, tipo y seccion. Se utilizaron getters y setters como metodos de acceso
			else
				if (o == 3)
				{
		...
		//Funcion 4: Accesa a la clase Chamarra en donde el usuario podra escoger el tipo de chamarra que desea comprar, añadiendo las caracteristicas de
		//talla, tipo, seccion y material. Se utilizaron getters y setters como metodos de acceso
					...
					if (o == 4) {
						...
						cout << "¿Qué bloque de chamarras quieres?" << endl;

						//Hay sobrecarga es por eso que se divide en dos, para cada tipo de constructor
						cout << "\nBLOQUE 1: Talla y Tipo \nBLOQUE 2: Talla, Tipo, Material y Seccion \nSelecione 1 o 2" << endl;
						cin >> op;
						//primer constructor
						if (op == 1) {
							Chamarra chamarra_1("\nTalla: \nCH \nM \nG \nXL", "\nTipo: \nInvierno \nVerano");
							...
							if (op == 2) { //segundo constructor
								...
								cout << "Introduzca la seccion Nino (N) o Adulto(A): " << endl;
								cin >> sec;
					...
					if (o == 5)
					{
						...
						if (fin == "s")
						{
							...
							if (fin == "n")
							{
								...
								cout << "OpciÃ³n invalida, intentelo de nuevo" << endl << endl;
					}
			...
			//Funcion 6: Accede a la clase Carrito para imprimir cuales son las prendas seleccionadas por el usuario
						...
						if (o == 6)
						{
							...
							for (int i=0; i < usuario.getpos_cham(); i++) {
								...
								cout << "Sec: " << usuario.getChamarra(i).getSeccion() << endl;
								}
							}
						}
				//Funcion 7: Salida
